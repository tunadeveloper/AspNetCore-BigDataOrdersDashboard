module.exports = function(grunt) {
    grunt.initConfig({
		sass: {
            ...
            dist: {
                ...
                files: [{
                    ...
                    'assets/css/animate_page.css': 'assets/scss/plugins/animate_page.scss', 	/* 'Animations Page scss ' */
        ...
        uglify: {
          my_target: {
            files: {
               'assets/bundles/libscripts.bundle.js': ['assets/plugins/jquery/jquery-v3.3.1.min.js','assets/plugins/bootstrap/js/bootstrap.bundle.min.js'], /* main js*/              
               ...
               'assets/bundles/flotchartsscripts.bundle.js': ['Assets/plugins/flot-charts/jquery.flot.js','Assets/plugins/flot-charts/jquery.flot.resize.js',               
               'assets/plugins/flot-charts/jquery.flot.pie.js','Assets/plugins/flot-charts/jquery.flot.categories.js','Assets/plugins/flot-charts/jquery.flot.time.js'], /* flotchartsscripts Plugin Js */                              'assets/bundles/fullcalendarscripts.bundle.js': ['assets/plugins/fullcalendar/lib/moment.min.js','assets/plugins/fullcalendar/lib/jquery-ui.min.js','assets/plugins/fullcalendar/fullcalendar.min.js'],   /* calender page js */
               ...
               'assets/bundles/jvectormap.bundle.js': ['assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js','assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js'], /* Map js*/               
               ...
               'assets/bundles/footable.bundle.js': ['assets/plugins/footable-bootstrap/js/footable.min.js'], /* knob js*/
              }
            }
        }                
    });
